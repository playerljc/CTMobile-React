  ...
  return new Promise((resolve, reject) => {
    ...
    if (ctDataMode.toLowerCase().indexOf('singleinstance') !== -1 && singleInstance) {
      ...
      if (pageRouterConfig) {
        ...
        (component.then ? component : Promise.resolve(component))
          .then((reactComponentWrap) => {
            ...
            // 每个页的逻辑组件
            const ReactComponent = reactComponentWrap.default || reactComponentWrap;
            // 顶层容器
