...
function PageWrap(WrappedComponent) {
  return forwardRef((props, ref) => (
    <WrappedComponent ref={ref} wrapRef={ref} {...props}>
      {props.children}
    </WrappedComponent>
  ));
}
...
const Page = {
  /**
   * 高阶方法
   * @param el - Page的顶层html定义
   * @return {function(*)}
   */
  create: (el) => (WrappedComponent) => {
    /**
     * PageComponent
     * @class Page
    ...
    class PageComponent extends React.Component {
      ...
      constructor(props) {
        ...
        this.PageComponent = PageWrap(WrappedComponent);
       ...
       */
      componentDidMount() {
        if (this.ins.current && this.ins.current.pageCreate) {
          this.ins.current.pageCreate();
        }
       ...
       */
      pageBeforeShow(e) {
        if (this.ins.current && this.ins.current.pageBeforeShow) {
          this.ins.current.pageBeforeShow(e);
        }
      }
       ...
       */
      pageShow(e) {
        if (this.ins.current && this.ins.current.pageShow) {
          this.ins.current.pageShow(e);
        }
      }
       ...
       */
      pageAfterShow(e) {
        if (this.ins.current && this.ins.current.pageAfterShow) {
          this.ins.current.pageAfterShow(e);
        }
      }
       ...
       */
      pageBeforePause(e) {
        if (this.ins.current && this.ins.current.pageBeforePause) {
          this.ins.current.pageBeforePause(e);
        }
      }
       ...
       */
      pageAfterPause(e) {
        if (this.ins.current && this.ins.current.pageAfterPause) {
          this.ins.current.pageAfterPause(e);
        }
      }
       ...
       */
      pageBeforeRestore(e) {
        if (this.ins.current && this.ins.current.pageBeforeRestore) {
          this.ins.current.pageBeforeRestore(e);
        }
      }
       ...
       */
      pageRestore(e) {
        if (this.ins.current && this.ins.current.pageRestore) {
          this.ins.current.pageRestore(e);
        }
      }
       ...
       */
      pageAfterRestore(e) {
        if (this.ins.current && this.ins.current.pageAfterRestore) {
          this.ins.current.pageAfterRestore(e);
        }
      }
       ...
       */
      pageBeforeDestroy(e) {
        if (this.ins.current && this.ins.current.pageBeforeDestroy) {
          this.ins.current.pageBeforeDestroy(e);
        }
      }
      ...
      pageResult(e, resultCode, bundle) {
        if (this.ins.current && this.ins.current.pageResult) {
          this.ins.current.pageResult(e, resultCode, bundle);
        }
      }
      ...
      pageReceiver(bundle, functions) {
        if (this.ins.current && this.ins.current.pageReceiver) {
          this.ins.current.pageReceiver(bundle, functions);
        }
      }
      ...
      render() {
        ...
        return (
          ...
          <Provider value={this.getCtMobile()}>
            <PageComponent ref={this.ins} {...this.props} {...mergeProps} />
          </Provider>
        );
      }
    }
