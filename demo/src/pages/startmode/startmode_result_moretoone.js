    ...
    return (
      <React.Fragment>
        <header>
          ...
          <p className="ct-header-title">startmode_result_moretoone</p>
        </header>
        <div className="ct-content" style={{ top: '3rem', bottom: 0 }}>
          <ul>
            <li>
              <Link className="link" pageId="startmode_result_moretoone_page1">
                startmode_result_moretoone_page1
              </Link>
            </li>
            <li>
              <Link className="link" pageId="startmode_result_moretoone_page2">
