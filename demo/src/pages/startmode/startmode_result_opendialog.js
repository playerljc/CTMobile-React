...
export default (props) => {
  usePageEffect(props.wrapRef, {
     ...
     */
    pageCreate(e) {
      props.parent.setRequest(props.parent.getPageId(), {});
    },
  ...
  return (
    <>
      <header>
        ...
        <p className="ct-header-title">startmode_result_opendialog</p>
      </header>
        ...
        <ul>
          <li>
            <a
              className="link"
              onClick={() => {
                const request = props.parent.getRequest();
                props.parent.setResult(request.requestCode, { a: 1, b: 2 });
                props.parent.over();
              }}
            >
              关闭窗体并返回数据
